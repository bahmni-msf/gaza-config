DELETE FROM global_property WHERE property = 'bahmni.sqlGet.upComingAppointments';
...
FROM
  ...
  LEFT JOIN provider prov ON prov.provider_id = pap.provider_id
  LEFT JOIN person_name psn ON psn.person_id = prov.person_id
