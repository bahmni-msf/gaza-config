...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"Irrigation NaCl 0.9 percentage","Irrigation NaCl 0.9%","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"Referred","Referred","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"PVI 4 percentage soap diluted","PVI 4% soap diluted","N/A","Misc",false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"Zinc Oxide 10 percentage ointment","Zinc Oxide 10% ointment","N/A","Misc",false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"PVI 7.5 percentage soap","PVI 7.5% soap","N/A","Misc",false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"PVI 10 percentage gel","PVI 10% gel","N/A","Misc",false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"PVI 10 percentage sol.","PVI 10% sol.","N/A","Misc",false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"PVI 10 percentage sol. Diluted","PVI 10% sol. Diluted","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"Mechanically by NaCl 0.9 percentage and Gauze","Mechanically by NaCl 0.9 % and Gauze","N/A","Misc",false);
