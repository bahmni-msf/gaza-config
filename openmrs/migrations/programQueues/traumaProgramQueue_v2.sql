...
identifier,
concat(GivenNameArabic,' ', ifnull(FamilyNameArabic,'')) as PATIENT_LISTING_QUEUES_PATIENT_NAME_IN_ARABIC,
concat(given_name,' ', ifnull(family_name,'')) as PATIENT_LISTING_QUEUES_PATIENT_NAME_IN_ENGLISH,
