...
AND pg.name = 'Trauma' AND pp.outcome_concept_id IS NULL AND pp.voided is false AND pp.date_voided is null AND cn.concept_name_type='FULLY_SPECIFIED' AND cn.locale='en'
)pu
