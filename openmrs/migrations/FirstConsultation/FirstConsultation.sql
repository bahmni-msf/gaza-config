...
#Add Parent Concepts
#Add Date Concepts
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Date","Date","Date","Misc",false);

#Add Text Concepts
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Other injury, specify","Other injury, specify","Text","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Other referral location, specify","Other referral location, specify","Text","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Free text comment","Free text comment","Text","Misc",false);

#Add Coded Concepts
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Source of initial patient referral","Source of initial patient referral","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, MoH facility","MoH facility","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, UNRWA facility","UNRWA facility","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, NGO facility","NGO facility","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Private facility type","Private facility type","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Type of injury","Type of injury","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Admission status","Admission status","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Reason of rejection","Reason of rejection","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Out of criteria","Out of criteria","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Patient sent to another actor?","Patient sent to another actor?","Coded","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"IC, Referral location:","Referral location:","Coded","Misc",false);
